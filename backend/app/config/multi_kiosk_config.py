...
try:
    ...
    from pydantic import BaseSettings, Fieldlti-Kiosk Configuration and Optimization Settings
Cấu hình tối ưu cho hệ thống nhiều kiosk devices
"""
import os
from typing import Dict, Any
...
MULTI_KIOSK_ENV_TEMPLATE = """
# Multi-Kiosk Optimization Settings
# Copy này vào .env.multi-kiosk file
...
# Database Settings (cho nhiều kiosks)
DB_POOL_SIZE=20
DB_MAX_OVERFLOW=40
DB_POOL_TIMEOUT=30
DB_POOL_RECYCLE=300
