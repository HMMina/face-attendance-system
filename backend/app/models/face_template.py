...
"""
from sqlalchemy import Column, Integer, String, DateTime, Float, ARRAY, CheckConstraint, UniqueConstraint
...
class FaceTemplate(Base):
    ...
    confidence_score = Column(Float, default=0.0)      # Recognition confidence when created
